...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="nav-links">
                ...
                <a href="events.html#register" class="nav-btn register-btn">Register Now</a>
            </div>
        </div>
    </nav>
    `;
    ...
    // Remove any existing footer before adding the new one
    const existingFooter = document.querySelector('footer');
    if (existingFooter) {
        existingFooter.remove();
    }
    
    // Add the footer script to the body
